...
We are going to use the ASE interface to the SIESTA calculator, for the official SIESTA documentation see SIESTA_.
...
basis set specifically optimized for the H2O molecule. Use the
