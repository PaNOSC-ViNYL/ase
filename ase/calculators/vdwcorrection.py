...
class vdWTkatchenko09prl(Calculator):
    ...
    def __init__(self,
                 ...
                 txt=None, sR=None,
                 implementation = "new" # Remove this ?
                ):
        """Constructor
...
# IS THIS A BUG??? FORCES ARE *NOT* BEING DOUBLE COUNTED!!! CHECK THIS!!!!
            self.results['forces'] += forces / 2.  # double counting
#


        # New implementation by Miguel Caro (complains etc to mcaroba@gmail.com)
