...
class Siesta3_2(BaseSiesta):
    ...
    unit_fdf_keywords = {
        ...
        'ON_eta_beta': 'eV',
        'ON_RcLWF': 'Ang',
        'ON_ChemicalPotentialRc': 'Ang',
        'ON_ChemicalPotentialTemperature': 'eV',
        'Optical_Energy_Minimum': 'eV',
        'Optical_Energy_Maximum': 'eV',
        'Optical_Broaden': 'eV',
        'Optical_Scissor': 'eV',
        'MD_MaxForceTol': 'eV/Ang',
        'MD_MaxStressTol': 'eV/Ang**3',
        'MD_MaxCGDispl': 'Ang',
        'MD_PreconditioningVariableCell': 'Ang',
        'ZM_ForceTolLength': 'eV/Ang',
        'ZM_ForceTolAngle': 'eV/rad',
        'ZM_MaxDiplLength': 'Ang',
        'MD_FIRE_TimeStep': 's',
        'MD_TargetPressure': 'eV/Ang**3',
        'MD_LengthTimeStep': 's',
        'MD_InitialTemperature': 'eV',
        'MD_TargetTemperature': 'eV',
        'MD_NoseMass': 'Kg*m**2',               #Not in ASE unit
        'MD_ParrinelloRahmanMass': 'Kg*m**2',   #Not in ASE unit
        'MD_TauRelax': 's',
        'MD_BulkModulus': 'eV/Ang**3',
        'MD_FCDispl': 'Ang'
    }
