...
calc.params = params
calc.run(set_atoms=True)    # set_atoms=True to read final coordinates after minimization
ar_nc.set_positions(calc.atoms.positions)   # get final coordinates after minimization
