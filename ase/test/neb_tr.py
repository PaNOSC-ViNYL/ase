...
neb = NEB (images, remove_translation=True, remove_rotation = True)
neb.interpolate()
...
neb = NEB (images, climb=True, remove_translation=True, remove_rotation = True)
...
assert abs(Ef_neb-Ef_neb_rt) < 1e-4
