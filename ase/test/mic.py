...
assert all(abs(a.get_distances(0, [0, 1, 2, 3], mic=False) - all_dist[0]) < tol)
assert all(abs(a.get_distances(1, [0, 1, 2, 3], mic=False) - all_dist[1]) < tol)
assert all(abs(a.get_distances(2, [0, 1, 2, 3], mic=False) - all_dist[2]) < tol)
assert all(abs(a.get_distances(3, [0, 1, 2, 3], mic=False) - all_dist[3]) < tol)
