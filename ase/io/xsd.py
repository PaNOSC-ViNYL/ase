...
def write_xsd(filename, atoms):
    ...
    # periodic system
        ...
        atom_positions = numpy.dot(atom_positions,numpy.linalg.inv(atom_cell))
        ...
        SymmSys.set('XYZ','0.00000000000000,0.00000000000000,0.000000000000000');
