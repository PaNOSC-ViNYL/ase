...
atoms = crystal(spacegroup=%(spacegroup)d,
                ...
                cellpar=%(cellpar)s)
"""
label_template = """ %(natoms)i atoms: %(symbols)s, Volume: %(volume).3f A<sup>3</sup>"""
...
class SetupBulkCrystal(SetupWindow):
    ...
    def __init__(self, gui):
        ...
        self.set_title("Create Bulk Crystal by Spacegroup")
        self.atoms = None
        vbox = gtk.VBox()
        ...
        pack(vbox, [gtk.Label("Size: x: "), buttons[0],
                    gtk.Label("  y: "), buttons[1],
                    gtk.Label("  z: "), buttons[2],
        ...
        self.lattice_lequals[0].append_text('free')
        self.lattice_lequals[0].append_text('equals b')
        self.lattice_lequals[0].append_text('equals c')
        self.lattice_lequals[0].append_text('fixed')
        self.lattice_lequals[1].append_text('free')
        self.lattice_lequals[1].append_text('equals a')
        self.lattice_lequals[1].append_text('equals c')
        self.lattice_lequals[1].append_text('fixed')
        self.lattice_lequals[2].append_text('free')
        self.lattice_lequals[2].append_text('equals a')
        self.lattice_lequals[2].append_text('equals b')
        self.lattice_lequals[2].append_text('fixed')
        self.lattice_aequals[0].append_text('free')
        self.lattice_aequals[0].append_text('equals beta')
        self.lattice_aequals[0].append_text('equals gamma')
        self.lattice_aequals[0].append_text('fixed')
        self.lattice_aequals[1].append_text('free')
        self.lattice_aequals[1].append_text('equals alpha')
        self.lattice_aequals[1].append_text('equals gamma')
        self.lattice_aequals[1].append_text('fixed')
        self.lattice_aequals[2].append_text('free')
        self.lattice_aequals[2].append_text('equals alpha')
        self.lattice_aequals[2].append_text('equals beta')
        self.lattice_aequals[2].append_text('fixed')
        for i in range(3):
            self.lattice_lequals[i].set_active(0)
            self.lattice_aequals[i].set_active(0)
        pack(vbox,[gtk.Label('Lattice parameters')])
        pack(vbox,[gtk.Label('\t\ta:\t')  , self.lattice_lbuts[0],gtk.Label('  '),self.lattice_lequals[0],
                   gtk.Label('\talpha:\t'), self.lattice_abuts[0],gtk.Label('  '),self.lattice_aequals[0]])
        pack(vbox,[gtk.Label('\t\tb:\t')  , self.lattice_lbuts[1],gtk.Label('  '),self.lattice_lequals[1],
                   gtk.Label('\tbeta:\t') , self.lattice_abuts[1],gtk.Label('  '),self.lattice_aequals[1]])
        pack(vbox,[gtk.Label('\t\tc:\t')  , self.lattice_lbuts[2],gtk.Label('  '),self.lattice_lequals[2],
                   gtk.Label('\tgamma:\t'), self.lattice_abuts[2],gtk.Label('  '),self.lattice_aequals[2]])
        self.get_data = gtk.Button("Get from database")
        ...
        pack(vbox,[gtk.Label("")])
        self.pybut = PyButton("Creating a crystal.")
    ...
    def update(self, *args):
        ...
        if valid:
            ...
            try: 
                ...
                self.atoms = None
                self.status.set_markup("Please specify a consistent set of atoms.")
        else:
            self.atoms = None
            self.status.set_markup("Please specify a consistent set of atoms.")
    ...
    def get_from_database(self, *args):
        ...
        if index == len(crystal_definitions) or not self.legal_element:
            oops("Can't find lattice definition!")
            return False
